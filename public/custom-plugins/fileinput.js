/*
 * MyRentalHost v2.1 - FileInput Plugin JS
 * This file is part of MyRentalHost, an Admin template build for sale at ThemeForest.
	...
	FileInput.prototype = {
		...
		_build: function () {
			...
			this.container = $( '<div class="fileinput-holder" style="position: relative;"></div>' )
				.append( $( '<input type="text" class="fileinput-preview" style="width: 200px;" readonly="readonly" />' )
					.attr('placeholder', this.options.placeholder ) 
				)
				.append( $( '<span class="fileinput-btn btn" type="button" ' +
					'style="overflow: hidden; position: relative; left: 0; cursor: pointer;"></span>' )
